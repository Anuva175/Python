...
data = {
    ...
    "UnitPrice": [55000,120,1500,25000,40,800,50,2500,1500,90,3000,48,600,35,8000,25,4500,45,1200,1100,55,2500,150,1800,12,35,600,45,52000,1500,25,50,26000,90,120,800,1500,2800,40,35,3000,2000,1100,1200,25,50,8200,600,800,45],
    "TotalPrice": [55000,360,3000,25000,200,3200,500,2500,3000,270,3000,576,1200,350,8000,150,4500,180,1200,2200,275,2500,450,1800,120,210,1800,225,52000,1500,100,450,26000,180,360,1600,1500,2800,240,140,3000,2000,1100,2400,175,650,8200,1200,1600,135],
    "PaymentMethod": ["Credit Card","Cash","Credit Card","UPI","Cash","Credit Card","UPI","Credit Card","Cash","Credit Card","UPI","Cash","Credit Card","Cash","UPI","Credit Card","UPI","Cash","UPI","Credit Card",
                      "UPI","Cash","UPI","Credit Card","Cash","UPI","Cash","UPI","Credit Card","Cash","Credit Card","UPI","Cash","UPI","Credit Card","UPI","Credit Card","Cash","UPI","Cash","UPI","Credit Card","UPI","Cash","UPI","Credit Card","UPI","Cash","UPI","Credit Card"],
